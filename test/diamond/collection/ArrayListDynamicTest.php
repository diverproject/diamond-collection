...
/**
 * ArrayList test case with dynamic size.
 */
class ArrayListDynamicTest extends DiamondCollectionTest
{
	/**
	 * @var int
	 */
	...
	public function testSize()
	{
		...
		foreach ($this->newRandomElements() as $index => $element)
		{
			...
			$this->assertEquals($index + 1, $this->arrayList->count());
		}
	}
